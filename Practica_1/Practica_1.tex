...
Es pot observar que la corba queda per sota, en la majoria de casos, de les dades obtingudes experimentalment. Això pot ser causat per una temperatura lleugerament superior durant l'experimentació i errors de mesura. Cal destacar que l'equació de Peng i Robinson s'ajusta a les dades en la fase liquida, en la de vapor i en la del gas. Tot hi així cal recordar que com totes les equacions teòriques només s'aproximen a la realitat.

Altrament, l'equació del gas ideal es va distanciant de les dades experimentals a mesura que augmenta la pressió, com era de suposar, ja que no té en compte que les interaccions entre les molècules augmenten a mesura que augmenta la pressió.
...
Com al gràfic anterior les dades experimentals també queden per sobre la corba de l'equació de Peng i Robinson. A més a més, s'observa com l'equació del gas ideal obté menys error en pressions baixes que l'equació de Peng i Robinson i, a mesura que augmenta la pressió, les dades es distancien de la corba del gas ideal i s'aproximen a les de l'equació de Peng i Robinson.
